...
<body class="min-h-screen flex items-center justify-center px-4">
    ...
    <div class="w-full max-w-md">
        ...
        <div class="rounded-2xl p-8" style="background-color: var(--surface); border: 1px solid var(--border);">
            <h2 class="text-3xl text-center mb-6" style="color: var(--text);">Sign In</h2>
            ...
            <form method="POST" action="/login" class="space-y-5">
                ...
                <div class="flex items-center gap-2">
                    ...
                    >
                    <label for="remember" class="text-sm" style="color: var(--muted);">Remember me</label>
                </div>
            ...
            <p class="text-center text-sm mt-6" style="color: var(--muted);">
                ...
                <a href="/register" class="hover:underline" style="color: var(--accent);">Create one</a>
            </p>
        </div>
    </div>
